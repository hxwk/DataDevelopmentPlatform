...
import com.dfssi.dataplatform.datasync.flume.agent.Clock;
import com.dfssi.dataplatform.datasync.flume.agent.Context;
import com.dfssi.dataplatform.datasync.flume.agent.Event;
import com.dfssi.dataplatform.datasync.flume.agent.SystemClock;
 ...
 */
  ...
  private final SSIHDFSEventSink.WriterCallback onCloseCallback;
  ...
  public AtomicInteger renameTries = new AtomicInteger(0);
  ...
  BucketWriter(long rollInterval, long rollSize, long rollCount, long batchSize,
      ...
      SinkCounter sinkCounter, int idleTimeout, SSIHDFSEventSink.WriterCallback onCloseCallback,
