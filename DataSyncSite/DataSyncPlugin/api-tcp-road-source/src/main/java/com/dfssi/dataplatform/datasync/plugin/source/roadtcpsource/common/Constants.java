...
public class Constants {
    ...
    //临时文件存储
    public static String tmpFileDir = "/tmp/vnndFile/";

    //上下线topic
    public static String LOGIN_TOPIC = "ROAD_VNND_LOGININFO_STATUS";
    //指令发送状态topic
    public static String INSTRUCTION_SEND_TOPIC = "ROAD_VNND_INSTRUCTION_SEND_STATUS";
    //指令执行状态topic
    public static String INSTRUCTION_RESULT_TOPIC = "ROAD_VNND_INSTRUCTION_RESULT_STATUS";
    //查询指令执行结果topic
    public static String INSTRUCTION_RESULT_QUERY_TOPIC = "ROAD_VNND_INSTRUCTION_RESULT_LIST";
    //通用指令执行状态
    public static String INSTRUCTION_COMMAN_RESULT_TOPIC = "ROAD_VNND_COMMAN_INSTRUCTION_RESULT_STATUS";
    //锁车状态topic
    public static String LOCKVEHICLE_STATUS_TOPIC = "ROAD_VNND_LOCKVEHICLE_STATUS_STATUS";
    //锁车参数设置状态topic
    public static String LOCKVEHICLE_PARAM_SET_TOPIC = "ROAD_LOCKVEHICLE_PARAM_SET_STATUS";
    //远程升级响应topic
    public static String REMOTEUPGRADEOTAPH_TOPIC = "REMOTEUPGRADEOTAPH_TOPIC";

    //SD目录参数上传所用
    public static String SD_PARAMS_TOPIC = "SD_PARAMS_TOPIC";

    //SD文件上传所用
    public static String SD_FILES_TOPIC = "SD_FILES_TOPIC";
    ...
    public static final String POSITIONINFORMATION_TOPIC_KEY = "ROAD_POSITIONINFORMATION_TOPIC_KEY";

    public static String POSITIONINFORMATION_TOPIC = "ROAD_POSITIONINFORMATION_0200_TOPIC";

    public static final String POSITIONINFORMATIONS_TOPIC_KEY = "ROAD_POSITIONINFORMATIONS_TOPIC_KEY";

    public static String POSITIONINFORMATIONS_TOPIC = "ROAD_POSITIONINFORMATION_0704_TOPIC";

    public static final String CANINFORMATION_TOPIC_KEY = "ROAD_CANINFORMATION_TOPIC_KEY";

    public static String CANINFORMATION_TOPIC = "ROAD_CANINFORMATION_0705_TOPIC";

    public static final String DRIVERCARDINFORMATION_TOPIC_KEY = "ROAD_DRIVERCARDINFORMATION_TOPIC_KEY";

    public static String DRIVERCARDINFORMATION_TOPIC = "ROAD_DRIVERCARDINFORMATION_TOPIC";

    public static String GPSANDCANINFORMATIC_TOPIC ="ROAD_GPSANDCANINFORMATIC_TOPIC";

    public static String AVRESOURCELIST_TOPIC = "ROAD_AVRESOURCELIST_TOPIC";

    public static String AVPROPERTY_TOPIC = "ROAD_AVPROPERTY_1003_TOPIC";

    public static String AVPASSENGERFLOW_TOPIC = "ROAD_AVPASSENGERFLOW_1005_TOPIC";

    public static String TERMINALPROPERTEIS_TOPIC = "ROAD_TERMINALPROPERTEIS_0107_TOPIC";

    public static String ABS_AUTOMATION_TOPIC="ROAD_ABS_AUTOMATION_TOPIC";

    public static String ABS_D001_TOPIC="ROAD_ABS_D001_TOPIC";

    public static String FAILUREREPORT_TOPIC = "FAILUREREPORT_TOPIC";
    ...
    public static String REGION_FAILURECODEINFO="failureCodeInfo";//车辆故障码


    //发送8106查询指定参数返回结果存入到redis相应的key中
    public static final String redis8106Key_normal = "8106_normal";

    public static final String redis8106Key_F002 = "8106_F002";

    public static final String redis8106Key_F003 = "8106_F003";

    public static final String redis8106Key_F004 = "8106_F004";

    public static final String redis8106Key_F005 = "8106_F005";

    public static final String redis8106Key_F006 = "8106_F006";

    public static final String redis8106Key_F007 = "8106_F007";

    public static final String redis8106Key_F008 = "8106_F008";

    public static final String redis8106Key_F009 = "8106_F009";

    public static final String redis8106Key_F00A = "8106_F00A";

    public static final String redis8106Key_F00B = "8106_F00B";

    public static final String redis8106Key_F00C = "8106_F00C";
}
