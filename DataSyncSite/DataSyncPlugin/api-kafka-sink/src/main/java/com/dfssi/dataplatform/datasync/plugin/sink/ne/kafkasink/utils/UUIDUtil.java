...
public abstract class UUIDUtil {
    ...
    public static String getRandomUuidByTrim(){
        UUID uuid = UUIDUtil.getRandomUUID();
        String uuidStr =  uuid.toString();
        uuidStr = uuidStr.replace("-", "");
        return uuidStr;
    }

    public static String getTimeBasedUuidByTrim(){
    ...
    public static void main(String[] args) {
        System.out.println(UUIDUtil.getRandomUuidByTrim());
        System.out.println(UUIDUtil.getTimeBasedUuidByTrim());
    }
