...
package com.dfssi.dataplatform.datasync.plugin.sink.kafka;
  ...
  public Status process() throws EventDeliveryException {
    ...
    try {
      ...
      for (; processedEvents < batchSize; processedEvents += 1) {
        ...
        logger.debug("headers:{},body:{}",headers.toString(),new String(eventBody));

        eventTopic = headers.get(EventHeader.HEADER_TOPIC);
        if (eventTopic == null) {
          eventTopic = topic;
        }
