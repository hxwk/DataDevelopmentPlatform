...
import static com.dfssi.dataplatform.plugin.tcpnesource.common.HandlersManger.msgHandlers;
...
public class MessageHandlerReader {
    ...
    private static final String UP_MESSAGE_HANDLER_CONFIG_PATH = "com.dfssi.dataplatform.plugin.tcpnesource/upproto-routing.xml";

    private static final String DOWN_MESSAGE_HANDLER_CONFIG_PATH = "com.dfssi.dataplatform.plugin.tcpnesource/downproto-routing.xml";
