...
public class Constants {
    ...
    public static String ABS_AUTOMATION_TOPIC="ABS_AUTOMATION_TOPIC";

    public static String REMOTEUPGRADEOTAPH_TOPIC = "REMOTEUPGRADEOTAPH_TOPIC";

    //查询终端参数返回应答0104 存入kafka的topic
    public static String TERMINALPARAM_TOPIC = "TERMINALPARAM_TOPIC";
