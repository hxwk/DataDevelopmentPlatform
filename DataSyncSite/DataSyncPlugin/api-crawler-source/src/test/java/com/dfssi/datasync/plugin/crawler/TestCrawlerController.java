package com.dfssi.datasync.plugin.crawler;

import com.dfssi.dataplatform.datasync.plugin.source.common.BaseCrawlerRuleParam;
import com.dfssi.dataplatform.datasync.plugin.source.crawler.WebCrawlerVisit;
...
public class TestCrawlerController {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("Load parameters and initial ,please waiting...");
