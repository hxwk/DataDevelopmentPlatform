...
import static com.dfssi.dataplatform.datasync.plugin.source.crawler.CrawlerSourceConfigurationConstants.BYTE_OFFSET_HEADER_KEY;

/**
 * flume , crawler taildir directory matcher
 * @author jianKang
 * @date 2017/11/24
 */
public class CrawlerTailFile {
    private static final Logger logger = LoggerFactory.getLogger(CrawlerTailFile.class);
    ...
    public CrawlerTailFile(File file, Map<String, String> headers, long inode, long pos)
            throws IOException {
    ...
    public boolean updatePos(String path, long inode, long pos) throws IOException {
        if (this.inode == inode && StringUtils.equals(this.path,path)) {
            setPos(pos);
            updateFilePos(pos);
