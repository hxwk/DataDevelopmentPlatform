...
public class CrawlerTaildirMatcher {
    private static final Logger logger = LoggerFactory.getLogger(CrawlerTaildirMatcher.class);
     ...
     */
    CrawlerTaildirMatcher(String fileGroup, String filePattern, boolean cachePatternMatching) {
    ...
    public boolean equals(Object o) {
        ...
        CrawlerTaildirMatcher that = (CrawlerTaildirMatcher) o;
