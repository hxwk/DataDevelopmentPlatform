...
public class ParameterConstant {
    ...
    public static final String family = "family";//默认值f family

    public static final String ROWKEY = "rowkey";

    public static final String ROWKEY_RULE = "rule";
    public static final String ROWKEY_RULE_PARAM = "param";
    ...
    public static final String ROWKEYCONCAT = "concat";//连接字段,前面要处理的字段后面不需要处理
