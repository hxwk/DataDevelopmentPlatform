 ...
 * 基类
 */
public class VnndF103ResMsg extends VnndResMsg{

    public String id() {
        return "jts.F103.nd.r";
    }
    ...
    private byte canStatus;//can总线状态  0正常 1异常
    private byte canContinuity;//can是否连续 0正常 1异常
    private String vdrId;//终端ID
    private String vin;
    private String classissNumber; //底盘号
    private int terminalValidRecords; //终端指令记录有效的条数（最大为0x05）
    private List<String> instructionExecutionRecord;   //指令执行记录
    private String manufacturerId;    //制造商ID
    private String terminalModel;     //终端型号
    private byte mainVersionNumber;   //主版本号
    private byte subversionNumber;      //子版本号
    ...
    public String getClassissNumber() {
        return classissNumber;
    }

    public void setClassissNumber(String classissNumber) {
        this.classissNumber = classissNumber;
    }
    public int getTerminalValidRecords() {
        return terminalValidRecords;
    }

    public void setTerminalValidRecords(int terminalValidRecords) {
        this.terminalValidRecords = terminalValidRecords;
    }

    public List<String> getInstructionExecutionRecord() {
        return instructionExecutionRecord;
    }

    public void setInstructionExecutionRecord(List<String> instructionExecutionRecord) {
        this.instructionExecutionRecord = instructionExecutionRecord;
    }
    ...
    public byte getMainVersionNumber() {
        return mainVersionNumber;
    }

    public void setMainVersionNumber(byte mainVersionNumber) {
        this.mainVersionNumber = mainVersionNumber;
    }

    public byte getSubversionNumber() {
        return subversionNumber;
    }

    public void setSubversionNumber(byte subversionNumber) {
