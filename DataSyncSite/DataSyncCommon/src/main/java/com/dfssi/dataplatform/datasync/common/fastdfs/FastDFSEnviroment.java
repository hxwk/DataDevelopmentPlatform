...
package com.dfssi.dataplatform.datasync.common.fastdfs;

import com.dfssi.dataplatform.datasync.common.common.FastDFSConfigReader;
import com.dfssi.dataplatform.datasync.common.common.IniFileReader;
 ...
 */
public class FastDFSEnviroment {
  ...
  public static void init() throws IOException, MyException {
    ...
    CompositeConfiguration config = FastDFSConfigReader.getInstance().getConfig();
  ...
  public static Socket getSocket(String ip_addr, int port) throws IOException {
    ...
    sock.setSoTimeout(FastDFSEnviroment.g_network_timeout);
    sock.connect(new InetSocketAddress(ip_addr, port), FastDFSEnviroment.g_connect_timeout);
    return sock;
  }
  ...
  public static Socket getSocket(InetSocketAddress addr) throws IOException {
    Socket sock = new Socket();
    sock.setSoTimeout(FastDFSEnviroment.g_network_timeout);
    sock.connect(addr, FastDFSEnviroment.g_connect_timeout);
    return sock;
  }
  ...
  public static void setG_connect_timeout(int connect_timeout) {
    FastDFSEnviroment.g_connect_timeout = connect_timeout;
  }
  ...
  public static void setG_network_timeout(int network_timeout) {
    FastDFSEnviroment.g_network_timeout = network_timeout;
  }
  ...
  public static void setG_charset(String charset) {
    FastDFSEnviroment.g_charset = charset;
  }
  ...
  public static void setG_tracker_http_port(int tracker_http_port) {
    FastDFSEnviroment.g_tracker_http_port = tracker_http_port;
  }
  ...
  public static void setG_anti_steal_token(boolean anti_steal_token) {
    FastDFSEnviroment.g_anti_steal_token = anti_steal_token;
  }
  ...
  public static void setG_secret_key(String secret_key) {
    FastDFSEnviroment.g_secret_key = secret_key;
  }
  ...
  public static void setG_tracker_group(TrackerGroup tracker_group) {
    FastDFSEnviroment.g_tracker_group = tracker_group;
  }
