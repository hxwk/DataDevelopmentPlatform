...
import com.dfssi.dataplatform.datasync.flume.agent.ChannelFullException;
...
import com.dfssi.dataplatform.datasync.flume.agent.annotations.Recyclable;
import com.dfssi.dataplatform.datasync.flume.agent.instrumentation.ChannelCounter;
...
public class MemoryChannel extends BasicChannelSemantics {
  ...
  private class MemoryTransaction extends BasicTransactionSemantics {
    ...
    protected void doPut(Event event) throws InterruptedException {
      ...
      LOGGER.info("event.head:{}",event.getHeaders());
