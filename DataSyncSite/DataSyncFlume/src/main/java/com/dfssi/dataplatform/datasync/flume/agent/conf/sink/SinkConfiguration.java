 ...
 * the License.
 */
package com.dfssi.dataplatform.datasync.flume.agent.conf.sink;

import com.dfssi.dataplatform.datasync.flume.agent.Context;
import com.dfssi.dataplatform.datasync.flume.agent.conf.*;
...
public class SinkConfiguration extends ComponentConfiguration {
  ...
  public enum SinkConfigurationType {
     ...
     * Null sink
     *
     * @see com.dfssi.dataplatform.datasync.service.agent.sink.NullSink
     */
