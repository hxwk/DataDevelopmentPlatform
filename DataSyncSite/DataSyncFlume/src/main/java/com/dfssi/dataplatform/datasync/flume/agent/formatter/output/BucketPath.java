...
package com.dfssi.dataplatform.datasync.flume.agent.formatter.output;

import com.dfssi.dataplatform.datasync.flume.agent.Clock;
import com.dfssi.dataplatform.datasync.flume.agent.SystemClock;
import com.dfssi.dataplatform.datasync.flume.agent.tools.TimestampRoundDownUtil;
...
public class BucketPath {
   ...
   * must be one of the units specified by {@link Calendar} -
