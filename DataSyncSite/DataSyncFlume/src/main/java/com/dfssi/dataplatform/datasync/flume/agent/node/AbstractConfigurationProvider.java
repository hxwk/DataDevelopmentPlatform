...
import com.dfssi.dataplatform.datasync.flume.agent.annotations.Disposable;
import com.dfssi.dataplatform.datasync.flume.agent.channel.ChannelProcessor;
import com.dfssi.dataplatform.datasync.flume.agent.channel.ChannelSelectorFactory;
import com.dfssi.dataplatform.datasync.flume.agent.channel.DefaultChannelFactory;
...
import com.dfssi.dataplatform.datasync.flume.agent.conf.FlumeConfiguration;
import com.dfssi.dataplatform.datasync.flume.agent.conf.channel.ChannelSelectorConfiguration;
import com.dfssi.dataplatform.datasync.flume.agent.conf.sink.SinkConfiguration;
...
import com.dfssi.dataplatform.datasync.flume.agent.sink.DefaultSinkFactory;
import com.dfssi.dataplatform.datasync.flume.agent.sink.DefaultSinkProcessor;
import com.dfssi.dataplatform.datasync.flume.agent.sink.SinkGroup;
import com.dfssi.dataplatform.datasync.flume.agent.source.DefaultSourceFactory;
...
public abstract class AbstractConfigurationProvider implements ConfigurationProvider {
  ...
  private void loadChannels(FlumeConfiguration.AgentConfiguration agentConf,
  ...
  private void loadSinks(FlumeConfiguration.AgentConfiguration agentConf,
