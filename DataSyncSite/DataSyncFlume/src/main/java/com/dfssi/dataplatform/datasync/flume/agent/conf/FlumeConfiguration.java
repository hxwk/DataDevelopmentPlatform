...
import com.dfssi.dataplatform.datasync.flume.agent.conf.FlumeConfigurationError.ErrorOrWarning;
import com.dfssi.dataplatform.datasync.flume.agent.conf.channel.ChannelConfiguration;
...
import com.dfssi.dataplatform.datasync.flume.agent.conf.sink.SinkType;
import com.dfssi.dataplatform.datasync.flume.agent.conf.source.SourceConfiguration;
import com.dfssi.dataplatform.datasync.flume.agent.conf.source.SourceType;
import com.dfssi.dataplatform.datasync.flume.agent.node.ConfigurationProvider;
...
public class FlumeConfiguration {
  ...
  public static class AgentConfiguration {
    ...
    private boolean isValid() {
      ...
      if (logger.isDebugEnabled() && com.dfssi.dataplatform.datasync.flume.agent.conf.LogPrivacyUtil.allowLogPrintConfig()) {
