...
import com.dfssi.dataplatform.datasync.flume.agent.interceptor.InterceptorChain;
...
public class ChannelProcessor implements Configurable {
    ...
    private void configureInterceptors(Context context) {
        ...
        for (String interceptorName : interceptorNames) {
            ...
            LOG.info("interceptorContext.getString(\"type\"):{}", type);
            if (type == null) {
            ...
            try {
                ...
                LOG.info("interceptorContext:{}", interceptorContext.toString());
        ...
        for (Channel reqChannel : reqChannelQueue.keySet()) {
            ...
            try {
                ...
                for (Event event : batch) {
                    LOG.debug("event:{}", event.getHeaders());
                    LOG.debug("event:{}", new String(event.getBody()));
