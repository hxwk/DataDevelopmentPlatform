...
Client_name="DataSyncServiceClientTest1"
Client_name_cn="数据接入client端1-测试"
...
(nohup ${a_new}/bin/java -server \
	           -Dname=${Client_name} \
                   -Dlog4j.configurationFile=../../config/log4j2-client.xml \
                   ...
                   -conf ../../config/client.properties > ../../logs/nohup 2>&1 &)
echo [$Client_name_cn]正在运行
