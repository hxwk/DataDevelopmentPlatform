package com.dfssi.dataplatform.external.chargingPile.controller;

import com.dfssi.dataplatform.external.chargingPile.service.ExternalOperatorService;
...
public class ExternalOperatorController {
    ...
    @RequestMapping(value = "/notification_stationInfo", method = RequestMethod.POST)
    @ResponseBody
//    @LogAudit
    public Object notificationStationInfo(HttpServletRequest request,@RequestBody String stationInfo) throws  Exception {
        logger.info("~~~~~~~~~~~~~~~~~~enter notificationStationInfo~~~~~~~~~~~~~~~~");
        logger.info(stationInfo.toString());
...
//    @LogAudit
    public Object queryStationsInfo(@RequestParam("lastQueryTime") String lastQueryTime, @RequestParam("pageNo") String pageNo, @RequestParam("pageSize") String pageSize, @RequestParam("operatorId") String operatorId) throws Exception {
        logger.info("进入查询充电桩信息并入库:{},{},{},{}",lastQueryTime,pageNo,pageSize,operatorId);
...
//    @LogAudit
    ...
    @RequestMapping(value = "/notification_orderInfo", method = RequestMethod.POST)
    @ResponseBody
//    @LogAudit
