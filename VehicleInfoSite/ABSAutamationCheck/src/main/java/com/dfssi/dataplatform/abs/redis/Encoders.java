...
public class Encoders {
  ...
  public static class Strings {
    ...
    public static int decode2Int(ByteBuf buf) {
      return Integer.parseInt(decode(buf));
    }

    public static double decode2Double(ByteBuf buf) {
      return Double.parseDouble(decode(buf));
    }

    public static long decode2Long(ByteBuf buf) {
      return Long.parseLong(decode(buf));
    }
  }
