...
package org.apache.spark.localMl.tree.impl
...
import org.apache.spark.localMl.classification.DecisionTreeClassificationModel
import org.apache.spark.localMl.feature.LabeledPoint
import org.apache.spark.localMl.regression.DecisionTreeRegressionModel
import org.apache.spark.localMl.tree._
import org.apache.spark.localMl.util.Instrumentation
...
private[spark] object RandomForest extends Logging {
   ...
   *
   * @param input Training data: RDD of [[org.apache.spark.localMl.tree.impl.TreePoint]]
   ...
   * @return Splits, an Array of [[org.apache.spark.localMllib.tree.model.Split]]
