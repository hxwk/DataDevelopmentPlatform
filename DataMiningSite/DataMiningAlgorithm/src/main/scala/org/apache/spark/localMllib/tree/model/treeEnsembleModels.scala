...
package org.apache.spark.localMllib.tree.model
...
import org.apache.spark.localMllib.tree.configuration.Algo
import org.apache.spark.localMllib.tree.configuration.Algo._
import org.apache.spark.localMllib.tree.configuration.EnsembleCombiningStrategy._
import org.apache.spark.localMllib.tree.loss.Loss
import org.apache.spark.localMllib.util.{Loader, Saveable}
...
object RandomForestModel extends Loader[RandomForestModel] {
  ...
  private[localMllib] def formatVersion: String = TreeEnsembleModel.SaveLoadV1_0.thisFormatVersion
  ...
  private object SaveLoadV1_0 {
    ...
    def thisClassName: String = "org.apache.spark.localMllib.tree.model.RandomForestModel"
  }
...
class GradientBoostedTreesModel @Since("1.2.0") (
   ...
   * @param data RDD of [[org.apache.spark.localMllib.regression.LabeledPoint]]
...
object GradientBoostedTreesModel extends Loader[GradientBoostedTreesModel] {
  ...
  private object SaveLoadV1_0 {
    // Hard-code class name string in case it changes in the future
    def thisClassName: String = "org.apache.spark.localMllib.tree.model.GradientBoostedTreesModel"
  }
...
private[tree] sealed class TreeEnsembleModel(
  ...
  /**
   * Java-friendly version of [[org.apache.spark.localMllib.tree.model.TreeEnsembleModel#predict]].
   */
...
private[tree] object TreeEnsembleModel extends Logging {
  ...
  object SaveLoadV1_0 {
    ...
    import org.apache.spark.localMllib.tree.model.DecisionTreeModel.SaveLoadV1_0.{NodeData, constructTrees}
