...
class IsotonicRegressionModel @Since("1.3.0") (
  ...
  private[localMllib] def boundaryVector: Vector = Vectors.dense(boundaries)

  /** A convenient method for boundaries called by the Python API. */
  private[localMllib] def predictionVector: Vector = Vectors.dense(predictions)
...
object IsotonicRegressionModel extends Loader[IsotonicRegressionModel] {
  ...
  private object SaveLoadV1_0 {
    ...
    def thisClassName: String = "org.apache.spark.localMllib.regression.IsotonicRegressionModel"
