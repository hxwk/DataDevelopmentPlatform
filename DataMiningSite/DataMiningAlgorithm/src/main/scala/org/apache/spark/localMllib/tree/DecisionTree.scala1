...
package org.apache.spark.localMllib.tree
...
import org.apache.spark.localMllib.tree.RandomForest.NodeIndexInfo
import org.apache.spark.localMllib.tree.configuration.Strategy
import org.apache.spark.localMllib.tree.configuration.Algo._
import org.apache.spark.localMllib.tree.configuration.FeatureType._
import org.apache.spark.localMllib.tree.configuration.QuantileStrategy._
import org.apache.spark.localMllib.tree.impl._
import org.apache.spark.localMllib.tree.impurity._
import org.apache.spark.localMllib.tree.model._
...
class DecisionTree @Since("1.0.0") (private val strategy: Strategy)
   ...
   * @param input Training data: RDD of [[org.apache.spark.localMllib.regression.LabeledPoint]]
...
object DecisionTree extends Serializable with Logging {
   ...
   *
   * Note: Using [[org.apache.spark.localMllib.tree.DecisionTree$#trainClassifier]]
   *       and [[org.apache.spark.localMllib.tree.DecisionTree$#trainRegressor]]
   *       is recommended to clearly separate classification and regression.
   *
   * @param input Training dataset: RDD of [[org.apache.spark.localMllib.regression.LabeledPoint]].
 ...
 @Since("1.0.0")
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.DecisionTree$#trainClassifier]]
   */
  @Since("1.1.0")
  def trainClassifier(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.DecisionTree$#trainRegressor]]
   */
  @Since("1.1.0")
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
   ...
   *
   * @param input Training data: RDD of [[org.apache.spark.localMllib.tree.impl.TreePoint]]
   ...
   *         Splits is an Array of [[org.apache.spark.localMllib.tree.model.Split]]
   *          of size (numFeatures, numSplits).
   *         Bins is an Array of [[org.apache.spark.localMllib.tree.model.Bin]]
