...
import org.apache.spark.localMl.linalg.BLAS._
import org.apache.spark.localMl.optim.WeightedLeastSquares
...
import org.apache.spark.localMllib.stat.MultivariateOnlineSummarizer
 ...
 */
@Since("1.3.0")
class LinearRegressionModel  ( //private[localMl]
...
object LinearRegressionModel extends MLReadable[LinearRegressionModel] {
  ...
  private class LinearRegressionModelReader extends MLReader[LinearRegressionModel] {
    ...
    override def load(path: String): LinearRegressionModel = {
      ...
      val Row(intercept: Double, coefficients: Vector) = data
