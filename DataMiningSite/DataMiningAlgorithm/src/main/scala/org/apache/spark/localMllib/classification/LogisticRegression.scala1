...
package org.apache.spark.localMllib.classification

import org.apache.spark.SparkContext
import org.apache.spark.annotation.Since
import org.apache.spark.localMllib.classification.impl.GLMClassificationModel
import org.apache.spark.localMllib.linalg.BLAS.dot
import org.apache.spark.localMllib.linalg.{DenseVector, Vector}
import org.apache.spark.localMllib.optimization._
import org.apache.spark.localMllib.pmml.PMMLExportable
import org.apache.spark.localMllib.regression._
import org.apache.spark.localMllib.util.{DataValidators, Saveable, Loader}
...
object LogisticRegressionModel extends Loader[LogisticRegressionModel] {
  ...
  override def load(sc: SparkContext, path: String): LogisticRegressionModel = {
    ...
    val classNameV1_0 = "org.apache.spark.localMllib.classification.LogisticRegressionModel"
 ...
 */
@Since("0.8.0")
class LogisticRegressionWithSGD private[localMllib] (
  ...
  override protected[localMllib] def createModel(weights: Vector, intercept: Double) = {
