...
package org.apache.spark.localMl.param.shared
 ...
 * {{{
 *   build/sbt "mllib/runMain org.apache.spark.localMl.param.shared.SharedParamsCodeGen"
 * }}}
 */
private[shared] object SharedParamsCodeGen {
  ...
  private def genHasParamTrait(param: ParamDesc[_]): String = {
    ...
    s"""
      ...
      | */
      |private[localMl] trait Has$Name extends Params {
      |
      |  /**
      |   * Param for $doc.
      |   * @group param
