...
import org.apache.spark.localMllib.feature.StandardScaler
import org.apache.spark.{Logging, SparkException}
import org.apache.spark.rdd.RDD
import org.apache.spark.localMllib.optimization._
import org.apache.spark.localMllib.linalg.{Vectors, Vector}
import org.apache.spark.localMllib.util.MLUtils._
...
abstract class GeneralizedLinearAlgorithm[M <: GeneralizedLinearModel]
   ...
   */
  private[localMllib] def setFeatureScaling(useFeatureScaling: Boolean): this.type = {
