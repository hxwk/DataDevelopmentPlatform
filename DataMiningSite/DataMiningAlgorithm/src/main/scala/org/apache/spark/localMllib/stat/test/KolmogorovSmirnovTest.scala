...
package org.apache.spark.localMllib.stat.test
...
private[stat] object KolmogorovSmirnovTest extends Logging {
   ...
   * @return [[org.apache.spark.localMllib.stat.test.KolmogorovSmirnovTestResult]] summarizing the test
   ...
   * @return [[org.apache.spark.localMllib.stat.test.KolmogorovSmirnovTestResult]] summarizing the
