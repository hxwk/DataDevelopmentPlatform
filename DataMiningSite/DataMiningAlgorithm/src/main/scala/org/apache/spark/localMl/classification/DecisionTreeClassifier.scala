...
package org.apache.spark.localMl.classification
 ...
 */
@Since("1.4.0")
class DecisionTreeClassificationModel private[localMl] (
    @Since("1.4.0")override val uid: String,
   ...
   */
  private[localMl] def this(rootNode: Node, numFeatures: Int, numClasses: Int) =
