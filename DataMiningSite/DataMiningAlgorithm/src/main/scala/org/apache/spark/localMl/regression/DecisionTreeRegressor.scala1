...
package org.apache.spark.localMl.regression
...
import org.apache.spark.localMl.{PredictionModel, Predictor}
import org.apache.spark.localMl.feature.LabeledPoint
import org.apache.spark.localMllib.linalg.Vector
import org.apache.spark.localMl.param.ParamMap
import org.apache.spark.localMl.tree._
import org.apache.spark.localMl.tree.DecisionTreeModelReadWrite._
import org.apache.spark.localMl.tree.impl.RandomForest
import org.apache.spark.localMl.util._
import org.apache.spark.localMllib.tree.configuration.{Algo => OldAlgo, Strategy => OldStrategy}
...
class DecisionTreeRegressor @Since("1.4.0") (@Since("1.4.0") override val uid: String)
  ...
  /** (private[localMl]) Train a decision tree on an RDD */
  private[localMl] def train(data: RDD[LabeledPoint],
  ...
  private[localMl] def getOldStrategy(categoricalFeatures: Map[Int, Int]): OldStrategy = {
 ...
 */
@Since("1.4.0")
class DecisionTreeRegressionModel private[localMl] (
   ...
   */
  private[localMl] def this(rootNode: Node, numFeatures: Int) =
