...
import org.apache.spark.localMl.attribute.{AttributeGroup, _}
...
import org.apache.spark.localMllib.feature
import org.apache.spark.localMllib.linalg.{Vector, VectorUDT, Vectors => OldVectors}
import org.apache.spark.localMllib.regression.{LabeledPoint => OldLabeledPoint}
 ...
 */
@Since("1.6.0")
final class ChiSqSelectorModel private[localMl] (
  ...
  override def transform(dataset: DataFrame): DataFrame = {
    ...
    val transformer: Vector => Vector = v => chiSqSelector.transform(v) //(OldVectors.fromML(v)).asML
