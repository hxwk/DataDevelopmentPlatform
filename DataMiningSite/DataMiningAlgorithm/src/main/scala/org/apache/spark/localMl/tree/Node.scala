...
import org.apache.spark.localMllib.tree.impurity.ImpurityCalculator
import org.apache.spark.localMllib.tree.model.{ImpurityStats,
...
sealed abstract class Node extends Serializable {
   ...
   */
  private[localMl] def impurityStats: ImpurityCalculator

  /** Recursive prediction helper method */
  private[localMl] def predictImpl(features: Vector): LeafNode
 ...
 */
class LeafNode private[localMl] (
    override val prediction: Double,
    override val impurity: Double,
    override private[localMl] val impurityStats: ImpurityCalculator) extends Node {

  override def toString: String =
    s"LeafNode(prediction = $prediction, impurity = $impurity)"

  override private[localMl] def predictImpl(features: Vector): LeafNode = this
 ...
 */
class InternalNode private[localMl] (
    override val prediction: Double,
    override val impurity: Double,
    val gain: Double,
    val leftChild: Node,
  ...
  override private[localMl] def predictImpl(features: Vector): LeafNode = {
  ...
  override private[localMl] def maxSplitFeatureIndex(): Int = {
 ...
 *            [[org.apache.spark.localMllib.tree.model.Node]], but this will change later.
...
private[tree] class LearningNode(
   ...
   *         [[org.apache.spark.localMl.tree.impl.RandomForest.findBestSplits()]].
   */
