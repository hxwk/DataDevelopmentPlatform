...
import org.apache.spark.localMllib.tree.loss.{LogLoss, SquaredError, Loss}

/**
 * Configuration options for [[org.apache.spark.localMllib.tree.GradientBoostedTrees]].
 *
 ...
 *                      validationTol * 0.01.
 *                      Ignored when
 *                      [[org.apache.spark.localMllib.tree.GradientBoostedTrees.run()]] is used.
 */
@Since("1.2.0")
