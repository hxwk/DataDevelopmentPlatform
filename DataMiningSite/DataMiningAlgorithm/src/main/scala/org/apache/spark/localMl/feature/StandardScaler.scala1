 ...
 */
@Since("1.2.0")
class StandardScalerModel private[localMl] (
    @Since("1.4.0") override val uid: String,
  ...
  override def transform(dataset: DataFrame): DataFrame = {
    ...
    val transformer: Vector => Vector = v => scaler.transform(v) //(OldVectors.fromML(v)).asML
...
object StandardScalerModel extends MLReadable[StandardScalerModel] {
  ...
  private class StandardScalerModelReader extends MLReader[StandardScalerModel] {
    ...
    override def load(path: String): StandardScalerModel = {
      ...
      val Row(std: Vector, mean: Vector) = data
