...
import org.apache.spark.localMl.param.{DoubleParam, ParamMap, ParamValidators}
 ...
 */
private[localMl] trait TrainValidationSplitParams extends ValidatorParams {
  /**
 ...
 */
@Since("1.5.0")
class TrainValidationSplitModel private[localMl] (
  ...
  private[localMl] def this(uid: String, bestModel: Model[_], validationMetrics: JList[Double]) = {
