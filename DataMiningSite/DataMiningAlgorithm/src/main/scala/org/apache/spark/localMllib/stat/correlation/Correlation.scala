...
package org.apache.spark.localMllib.stat.correlation

import org.apache.spark.localMllib.linalg.{DenseVector, Matrix, Vector}
 ...
 */
private[spark] object Correlations {
 ...
 */
private[spark] object CorrelationNames {
