...
import org.apache.spark.localMllib.evaluation.BinaryClassificationMetrics
import org.apache.spark.localMllib.linalg.BLAS._
...
class BinaryLogisticRegressionSummary private[classification] (
  ...
  private val sparkSession = predictions.sqlContext
