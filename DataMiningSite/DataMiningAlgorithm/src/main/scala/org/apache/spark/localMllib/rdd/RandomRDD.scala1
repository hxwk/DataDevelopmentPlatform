...
package org.apache.spark.localMllib.rdd

import org.apache.spark.{Partition, SparkContext, TaskContext}
import org.apache.spark.localMllib.linalg.{DenseVector, Vector}
import org.apache.spark.localMllib.random.RandomDataGenerator
...
private[localMllib] class RandomRDDPartition[T](override val index: Int,
    val size: Int,
...
private[localMllib] class RandomRDD[T: ClassTag](sc: SparkContext,
    size: Long,
    numPartitions: Int,
...
private[localMllib] class RandomVectorRDD(sc: SparkContext,
    size: Long,
    vectorSize: Int,
    numPartitions: Int,
...
private[localMllib] object RandomRDD {
