...
import org.apache.spark.localMl.{Estimator, Model, Pipeline, PipelineModel, PipelineStage, Transformer}
import org.apache.spark.localMl.attribute.AttributeGroup
import org.apache.spark.localMllib.linalg.VectorUDT
import org.apache.spark.localMl.param.{Param, ParamMap}
import org.apache.spark.localMl.param.shared.{HasFeaturesCol, HasLabelCol}
...
class RFormula @Since("1.5.0") (@Since("1.5.0") override val uid: String)
  ...
  private[localMl] def hasIntercept: Boolean = {
...
class RFormulaModel private[feature](
    ...
    private[localMl] val resolvedFormula: ResolvedRFormula,
    private[localMl] val pipelineModel: PipelineModel)
