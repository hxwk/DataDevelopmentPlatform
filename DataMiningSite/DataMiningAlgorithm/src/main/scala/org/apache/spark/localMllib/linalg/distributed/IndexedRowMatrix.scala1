...
package org.apache.spark.localMllib.linalg.distributed
...
import org.apache.spark.localMllib.linalg.SingularValueDecomposition

/**
 * Represents a row of [[org.apache.spark.localMllib.linalg.distributed.IndexedRowMatrix]].
 */
@Since("1.0.0")
case class IndexedRow(index: Long, vector: Vector)

/**
 * Represents a row-oriented [[org.apache.spark.localMllib.linalg.distributed.DistributedMatrix]] with
 * indexed rows.
 *
...
class IndexedRowMatrix @Since("1.0.0") (
   ...
   * [[org.apache.spark.localMllib.linalg.distributed.RowMatrix]].
   */
  @Since("1.0.0")
   ...
   * [[org.apache.spark.localMllib.linalg.distributed.CoordinateMatrix]].
   */
  @Since("1.3.0")
   ...
   *
   * U is an [[org.apache.spark.localMllib.linalg.distributed.IndexedRowMatrix]] of size m x k that
   * satisfies U'U = eye(k),
  ...
  private[localMllib] override def toBreeze(): BDM[Double] = {
    val m = numRows().toInt
    val n = numCols().toInt
