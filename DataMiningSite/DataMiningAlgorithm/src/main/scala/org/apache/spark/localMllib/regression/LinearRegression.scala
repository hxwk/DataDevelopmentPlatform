...
package org.apache.spark.localMllib.regression
...
import org.apache.spark.localMllib.regression.impl.GLMRegressionModel
import org.apache.spark.localMllib.util.{Saveable, Loader}
...
object LinearRegressionModel extends Loader[LinearRegressionModel] {
  ...
  override def load(sc: SparkContext, path: String): LinearRegressionModel = {
    ...
    val classNameV1_0 = "org.apache.spark.localMllib.regression.LinearRegressionModel"
 ...
 */
@Since("0.8.0")
class LinearRegressionWithSGD private[localMllib] (
