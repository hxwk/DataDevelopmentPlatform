...
package org.apache.spark.localMl
...
/**
 * (private[localMl])  Trait for parameters for prediction (regression and classification).
 */
private[localMl] trait PredictorParams extends Params
   ...
   *                          E.g., [[org.apache.spark.localMllib.linalg.VectorUDT]] for vector features.
...
abstract class Predictor[
   ...
   */
  private[localMl] def featuresDataType: DataType = new VectorUDT
