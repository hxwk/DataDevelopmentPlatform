...
package org.apache.spark.localMl.stat.distribution

import breeze.linalg.{diag, eigSym, max, DenseMatrix => BDM, DenseVector => BDV, Vector => BV}

import org.apache.spark.annotation.{DeveloperApi, Since}
import org.apache.spark.localMl.impl.Utils
...
class MultivariateGaussian @Since("2.0.0") (
  ...
  private[localMl] def this(mean: BDV[Double], cov: BDM[Double]) = {
  ...
  /** Returns density of this multivariate Gaussian at given point, x */
  private[localMl] def pdf(x: BV[Double]): Double = {
    math.exp(logpdf(x))
  }

  /** Returns the log-density of this multivariate Gaussian at given point, x */
  private[localMl] def logpdf(x: BV[Double]): Double = {
