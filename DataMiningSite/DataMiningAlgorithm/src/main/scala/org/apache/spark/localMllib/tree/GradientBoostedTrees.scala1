...
import org.apache.spark.localMllib.impl.PeriodicRDDCheckpointer
import org.apache.spark.localMllib.regression.LabeledPoint
import org.apache.spark.localMllib.tree.configuration.BoostingStrategy
import org.apache.spark.localMllib.tree.configuration.Algo._
import org.apache.spark.localMllib.tree.impl.TimeTracker
import org.apache.spark.localMllib.tree.impurity.Variance
import org.apache.spark.localMllib.tree.model.{DecisionTreeModel, GradientBoostedTreesModel}
...
class GradientBoostedTrees @Since("1.2.0") (private val boostingStrategy: BoostingStrategy)
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.GradientBoostedTrees!#run]].
   */
  @Since("1.2.0")
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.GradientBoostedTrees!#runWithValidation]].
   */
  @Since("1.4.0")
  def runWithValidation(
...
object GradientBoostedTrees extends Logging {
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.GradientBoostedTrees$#train]]
   */
  @Since("1.2.0")
  def train(
      input: JavaRDD[LabeledPoint],
