...
package org.apache.spark.localMl.attribute
...
private[attribute] trait AttributeFactory {
   ...
   */
  private[localMl] def decodeStructField(field: StructField, preserveName: Boolean): Attribute = {
...
object Attribute extends AttributeFactory {
  ...
  private[attribute] override def fromMetadata(metadata: Metadata): Attribute = {
    import org.apache.spark.localMl.attribute.AttributeKeys._
 ...
 */
@DeveloperApi
class NumericAttribute private[localMl] (
 ...
 */
@DeveloperApi
class NominalAttribute private[localMl] (
    override val name: Option[String] = None,
    override val index: Option[Int] = None,
 ...
 */
@DeveloperApi
class BinaryAttribute private[localMl] (
    override val name: Option[String] = None,
    override val index: Option[Int] = None,
