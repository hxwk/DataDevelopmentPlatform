...
import org.apache.spark.localMllib.tree.configuration.{Algo => OldAlgo}
import org.apache.spark.localMllib.tree.model.{RandomForestModel => OldRandomForestModel}
 ...
 */
@Since("1.4.0")
class RandomForestClassificationModel private[localMl] (
  ...
  /** (private[localMl]) Convert to a model in the old API */
  private[localMl] def toOld: OldRandomForestModel = {
