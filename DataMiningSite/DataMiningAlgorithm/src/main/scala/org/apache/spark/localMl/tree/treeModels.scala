...
import org.apache.spark.localMl.param.{Param, Params}
//import org.apache.spark.localMl.tree.DecisionTreeModelReadWrite.NodeData
import org.apache.spark.localMl.util.{DefaultParamsReader, DefaultParamsWriter}
import org.apache.spark.localMl.util.DefaultParamsReader.Metadata
import org.apache.spark.localMllib.tree.impurity.ImpurityCalculator
import org.apache.spark.localMllib.tree.model.{DecisionTreeModel => OldDecisionTreeModel}
...
private[spark] trait DecisionTreeModel {
   ...
   */
  private[localMl] def maxSplitFeatureIndex(): Int = rootNode.maxSplitFeatureIndex()
 ...
 */
private[localMl] trait TreeEnsembleModel[M <: DecisionTreeModel] {
...
private[localMl] object TreeEnsembleModel {
  ...
  /**
   * Info for a [[org.apache.spark.localMl.tree.Split]]
   *
...
private[localMl] object DecisionTreeModelReadWrite {
  ...
  def loadTreeNodes(
    ...
    val data = sparkSql.read.parquet(dataPath).as[NodeData]
...
/**
  ...
  */
case class EnsembleNodeData(treeID: Int,
                            nodeData: NodeData)
...
private[localMl] object EnsembleModelReadWrite {
