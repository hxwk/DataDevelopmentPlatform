...
package org.apache.spark.localMl.ann
 ...
 */
private[localMl] object FeedForwardTopology {
  /**
 ...
 */
private[localMl] class FeedForwardModel private(
    val weights: Vector,
 ...
 */
private[localMl] class FeedForwardTrainer(
    topology: Topology,
    val inputSize: Int,
