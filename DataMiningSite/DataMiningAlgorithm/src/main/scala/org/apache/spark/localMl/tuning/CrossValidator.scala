 ...
 */
private[localMl] trait CrossValidatorParams extends ValidatorParams {
  /**
...
class CrossValidator @Since("1.2.0") (@Since("1.4.0") override val uid: String)
  ...
  override def fit(dataset: DataFrame): CrossValidatorModel = {
    ...
    val sparkSession = dataset.sqlContext
    val est = $(estimator)
    val eval = $(evaluator)
 ...
 */
@Since("1.2.0")
class CrossValidatorModel private[localMl] (
  ...
  private[localMl] def this(uid: String, bestModel: Model[_], avgMetrics: JList[Double]) = {
