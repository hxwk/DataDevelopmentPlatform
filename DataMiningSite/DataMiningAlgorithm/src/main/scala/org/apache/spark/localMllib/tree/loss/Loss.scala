...
package org.apache.spark.localMllib.tree.loss

import org.apache.spark.annotation.{DeveloperApi, Since}
import org.apache.spark.localMllib.regression.LabeledPoint
import org.apache.spark.localMllib.tree.model.TreeEnsembleModel
...
trait Loss extends Serializable {
   ...
   * @param data Training dataset: RDD of [[org.apache.spark.localMllib.regression.LabeledPoint]].
   ...
   */
  private[localMllib] def computeError(prediction: Double, label: Double): Double
}
