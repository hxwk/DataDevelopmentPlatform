...
package org.apache.spark.localMllib.api.python
...
import org.apache.spark.localMllib.classification._
import org.apache.spark.localMllib.clustering._
import org.apache.spark.localMllib.evaluation.RankingMetrics
import org.apache.spark.localMllib.feature._
import org.apache.spark.localMllib.fpm.{FPGrowth, FPGrowthModel, PrefixSpan}
import org.apache.spark.localMllib.linalg._
import org.apache.spark.localMllib.linalg.distributed._
import org.apache.spark.localMllib.optimization._
import org.apache.spark.localMllib.random.{RandomRDDs => RG}
import org.apache.spark.localMllib.recommendation._
import org.apache.spark.localMllib.regression._
import org.apache.spark.localMllib.stat.correlation.CorrelationNames
import org.apache.spark.localMllib.stat.distribution.MultivariateGaussian
import org.apache.spark.localMllib.stat.test.{ChiSqTestResult, KolmogorovSmirnovTestResult}
import org.apache.spark.localMllib.stat.{
  KernelDensity, MultivariateStatisticalSummary, Statistics}
import org.apache.spark.localMllib.tree.configuration.{Algo, BoostingStrategy, Strategy}
import org.apache.spark.localMllib.tree.impurity._
import org.apache.spark.localMllib.tree.loss.Losses
import org.apache.spark.localMllib.tree.model.{DecisionTreeModel, GradientBoostedTreesModel, RandomForestModel}
import org.apache.spark.localMllib.tree.{DecisionTree, GradientBoostedTrees, RandomForest}
import org.apache.spark.localMllib.util.MLUtils
import org.apache.spark.localMllib.util.LinearDataGenerator
