...
import org.apache.spark.localMllib.linalg.{BLAS, Vector}
import org.apache.spark.localMl.optim._
...
@Experimental
@Since("2.0.0")
class GeneralizedLinearRegressionModel private[localMl] (
   ...
   */
  @Since("2.0.0")
  def evaluate(dataset: DataFrame): GeneralizedLinearRegressionSummary = {
