...
import org.apache.spark.localMl.attribute._
import org.apache.spark.localMllib.linalg.{DenseVector, SparseVector, Vector, VectorUDT}
...
private[localMl] trait VectorIndexerParams extends Params with HasInputCol with HasOutputCol {
 ...
 */
@Since("1.4.0")
class VectorIndexerModel private[localMl] (
    @Since("1.4.0") override val uid: String,
