...
package org.apache.spark.localMl.linalg

import org.apache.spark.localMllib.linalg.{Vector, Vectors, SparseVector, DenseVector}
import org.json4s.DefaultFormats
import org.json4s.JsonDSL._
import org.json4s.jackson.JsonMethods.{compact, render, parse => parseJson}

private[localMl] object JsonVectorConverter {
