...
package org.apache.spark.localMl.recommendation
...
import org.apache.spark.localMllib.linalg.CholeskyDecomposition
import org.apache.spark.localMllib.optimization.NNLS
 ...
 */
@Experimental
class ALSModel private[localMl] (
...
class ALS(override val uid: String) extends Estimator[ALSModel] with ALSParams
  ...
  import org.apache.spark.localMl.recommendation.ALS.Rating
