...
package org.apache.spark.localMl.tuning
...
import org.apache.spark.localMl.evaluation.Evaluator
import org.apache.spark.localMl.param.{Param, ParamMap, ParamPair, Params}
import org.apache.spark.localMl.param.shared.HasSeed
import org.apache.spark.localMl.util.{DefaultParamsReader, DefaultParamsWriter, MetaAlgorithmReadWrite, MLWritable}
 ...
 */
private[localMl] trait ValidatorParams extends HasSeed with Params {
...
private[localMl] object ValidatorParams {
  /**
