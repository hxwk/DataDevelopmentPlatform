...
import org.apache.spark.localMl.UnaryTransformer
import org.apache.spark.localMl.param.{DoubleParam, ParamValidators}
...
class Normalizer @Since("1.4.0") (@Since("1.4.0") override val uid: String)
  ...
  override protected def createTransformFunc: Vector => Vector = {
    ...
    vector => normalizer.transform(vector) //(OldVectors.fromML(vector)).asML
  }
