...
import org.apache.spark.localMl.param.{ParamMap, Params}
import org.apache.spark.localMl.param.shared.{HasInputCol, HasOutputCol}
import org.apache.spark.localMl.util._
import org.apache.spark.localMllib.linalg.{Vector => OldVector, Vectors => OldVectors}
...
@Experimental
@Since("2.0.0")
class MaxAbsScalerModel private[localMl] (
