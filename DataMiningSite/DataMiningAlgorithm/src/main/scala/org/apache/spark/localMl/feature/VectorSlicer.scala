...
import org.apache.spark.localMl.attribute.{Attribute, AttributeGroup}
import org.apache.spark.localMl.param.shared.{HasInputCol, HasOutputCol}
import org.apache.spark.localMl.param.{IntArrayParam, ParamMap, StringArrayParam}
...
final class VectorSlicer @Since("1.5.0") (@Since("1.5.0") override val uid: String)
   ...
   * These names must be specified by ML [[org.apache.spark.localMl.attribute.Attribute]]s.
