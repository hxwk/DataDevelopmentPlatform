...
import org.apache.spark.localMllib.linalg.{BLAS, DenseMatrix, DenseVector, SparseVector, Vector}
...
class NaiveBayesModel private[spark] (
  ...
  private[localMllib] def this(labels: Array[Double], pi: Array[Double], theta: Array[Array[Double]]) =
    this(labels, pi, theta, NaiveBayes.Multinomial)

  /** A Java-friendly constructor that takes three Iterable parameters. */
  private[localMllib] def this(
...
object NaiveBayesModel extends Loader[NaiveBayesModel] {
  ...
  import org.apache.spark.localMllib.util.Loader._

  private[localMllib] object SaveLoadV2_0 {

    def thisFormatVersion: String = "2.0"

    /** Hard-code class name string in case it changes in the future */
    def thisClassName: String = "org.apache.spark.localMllib.classification.NaiveBayesModel"
  ...
  private[localMllib] object SaveLoadV1_0 {
