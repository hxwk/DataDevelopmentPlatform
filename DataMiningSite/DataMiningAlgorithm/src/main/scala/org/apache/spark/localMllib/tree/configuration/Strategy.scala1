...
package org.apache.spark.localMllib.tree.configuration

import scala.beans.BeanProperty
import scala.collection.JavaConverters._

import org.apache.spark.annotation.Since
import org.apache.spark.localMllib.tree.impurity.{Variance, Entropy, Gini, Impurity}
 ...
 *              [[org.apache.spark.localMllib.tree.configuration.Algo.Classification]],
 *              [[org.apache.spark.localMllib.tree.configuration.Algo.Regression]]
 * @param impurity Criterion used for information gain calculation.
 *                 Supported for Classification: [[org.apache.spark.localMllib.tree.impurity.Gini]],
 *                  [[org.apache.spark.localMllib.tree.impurity.Entropy]].
 *                 Supported for Regression: [[org.apache.spark.localMllib.tree.impurity.Variance]].
 ...
 *                             [[org.apache.spark.localMllib.tree.configuration.QuantileStrategy.Sort]]
...
class Strategy @Since("1.3.0") (
  ...
  /**
   * Java-friendly constructor for [[org.apache.spark.localMllib.tree.configuration.Strategy]]
   */
  @Since("1.1.0")
  def this(
      algo: Algo,
...
object Strategy {
  ...
  /**
   * Construct a default set of parameters for [[org.apache.spark.localMllib.tree.DecisionTree]]
