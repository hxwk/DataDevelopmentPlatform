...
import org.apache.spark.localMl.attribute.{Attribute, NominalAttribute}
...
import org.apache.spark.localMl.{Estimator, Model, Transformer}
 ...
 */
@Since("1.5.0")
class IndexToString private[localMl] (@Since("1.5.0") override val uid: String)
