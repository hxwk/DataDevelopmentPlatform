...
import org.apache.spark.localMllib.tree.impl.{BaggedPoint, DecisionTreeMetadata, NodeIdCache,
  TimeTracker, TreePoint}
import org.apache.spark.localMllib.tree.impurity.Impurities
...
object RandomForest extends Serializable with Logging {
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.RandomForest$#trainClassifier]]
   */
  @Since("1.2.0")
  def trainClassifier(
  ...
  /**
   * Java-friendly API for [[org.apache.spark.localMllib.tree.RandomForest$#trainRegressor]]
   */
  @Since("1.2.0")
  def trainRegressor(
      input: JavaRDD[LabeledPoint],
