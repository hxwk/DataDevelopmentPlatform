...
import org.apache.spark.localMllib.linalg.{DenseMatrix, Matrices, Matrix, SparseMatrix}
 ...
 */
private[localMllib] class GridPartitioner(
    val rows: Int,
    val cols: Int,
    val rowsPerPart: Int,
...
private[localMllib] object GridPartitioner {
...
class BlockMatrix @Since("1.3.0") (
  ...
  private[localMllib] def createPartitioner(): GridPartitioner =
  ...
  private[localMllib] def toBreeze(): BDM[Double] = {
