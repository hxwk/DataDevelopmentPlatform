...
package org.apache.spark.localMllib.clustering

import scala.collection.mutable.ArrayBuffer

import org.apache.spark.Logging
import org.apache.spark.localMl.clustering.{KMeans => NewKMeans}
import org.apache.spark.localMl.util.Instrumentation
import org.apache.spark.annotation.{Experimental, Since}
import org.apache.spark.localMllib.linalg.{Vector, Vectors}
import org.apache.spark.localMllib.linalg.BLAS.{axpy, scal}
...
class KMeans private (
  ...
  private def runAlgorithm(
    ...
    while (iteration < maxIterations && !activeRuns.isEmpty) {
      ...
      val costAccums = activeRuns.map(_ => sc.accumulator(0.0)) //sc.doubleAccumulator
...
object KMeans {
   ...
   */
  private[localMllib] def findClosest(
   ...
   */
  private[localMllib] def pointCost(
      centers: TraversableOnce[VectorWithNorm],
   ...
   * [[org.apache.spark.localMllib.util.MLUtils#fastSquaredDistance]].
   */
 ...
 *
 * @see [[org.apache.spark.localMllib.clustering.KMeans#fastSquaredDistance]]
 */
private[clustering]
