...
private[spark] object InformationGainStats {
  /**
   * An [[org.apache.spark.localMllib.tree.model.InformationGainStats]] object to
...
private[spark] object ImpurityStats {
  ...
  /**
   * Return an [[org.apache.spark.localMllib.tree.model.ImpurityStats]] object to
   * denote that current split doesn't satisfies minimum info gain or
   * minimum number of instances per node.
   */
  ...
  /**
   * Return an [[org.apache.spark.localMllib.tree.model.ImpurityStats]] object
