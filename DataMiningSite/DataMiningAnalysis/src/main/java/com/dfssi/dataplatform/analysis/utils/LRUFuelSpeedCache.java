...
*/  
public class LRUFuelSpeedCache<K,V> {
   ...
   public LRUFuelSpeedCache(final int cacheSize){
      this(cacheSize, -1L);
   }
   ...
   */
   public LRUFuelSpeedCache(final int cacheSize, final long cacheOutTime) {
      ...
      this.map = new LinkedHashMap<K, TimeVaue<V>>(hashTableCapacity, hashTableLoadFactor, true) {
         ...
         protected boolean removeEldestEntry (Map.Entry<K, TimeVaue<V>> eldest) {
            ...
            return (status || size() > LRUFuelSpeedCache.this.cacheSize);
         }
      };
   ...
   */
   ...
   public static void main(String[] args) throws InterruptedException {
      LRUFuelSpeedCache<String, String> fuelSpeedCache = new LRUFuelSpeedCache<>(4, 1 * 30 * 1000L);
