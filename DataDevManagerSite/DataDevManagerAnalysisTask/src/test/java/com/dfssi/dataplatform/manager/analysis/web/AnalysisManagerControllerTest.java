package com.dfssi.dataplatform.manager.analysis.web;

import com.dfssi.dataplatform.manager.analysis.app.AnalysisManagerApp;
...
@SpringBootTest(classes = AnalysisManagerApp.class)
@WebAppConfiguration
public class AnalysisManagerControllerTest {
    @Autowired
