...
public class RoleController {
    ...
    @LogAudit
    public ResponseObj insertRole(@RequestBody Map<String, Object> models) {
    ...
    @LogAudit
    public ResponseObj modifyRole(@RequestBody Map<String, Object> models) {
            ResponseObj responseObj=ResponseObj.createResponseObj();
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "requestTreeType", value = "请求的树类型,1:新增功能菜单/新增菜单按钮。2:角色绑定。", required = true, dataType = "Integer")
    })
