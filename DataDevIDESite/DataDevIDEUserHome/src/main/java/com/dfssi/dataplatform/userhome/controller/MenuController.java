...
public class MenuController {
    ...
    @LogAudit
    public ResponseObj insertMenu(@RequestBody @Validated MenuEntity menuEntity, BindingResult bindingResult) {
         ResponseObj responseObj=ResponseObj.createResponseObj();
        try {
    ...
    @LogAudit
    public ResponseObj modifyMenu(@RequestBody @Validated MenuEntity menuEntity,BindingResult bindingResult) {
        ResponseObj responseObj=ResponseObj.createResponseObj();
        try {
            String str =fieldRulesService.paramValid(bindingResult);
            if(StringUtils.isNotEmpty(str)){
    ...
    public List getAllMenu(){
        ResponseObj responseObj=ResponseObj.createResponseObj();
        try {
            List<Object> list = menuService.getAllMenuNew();
