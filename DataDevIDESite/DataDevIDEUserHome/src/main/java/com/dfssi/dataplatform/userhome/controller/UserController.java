...
public class UserController {
    ...
    @LogAudit
    public ResponseObj insertMenu(@RequestBody @Validated UserEntity userEntity, BindingResult bindingResult) {
    ...
    @LogAudit
    public ResponseObj modifyMenu(@RequestBody @Validated UserEntity userEntity, BindingResult bindingResult) {
        ResponseObj responseObj=ResponseObj.createResponseObj();
        try {
            String str =fieldRulesService.paramValid(bindingResult);
            if(StringUtils.isNotEmpty(str)){
