package com.dfssi.dataplatform.ide.analysis.resource;
...
public class DBCommon {
	...
	public static Connection getConn(DBType type, String host, String port,
	...
	public static Connection getConn(DBConnectEntity entity) throws ClassNotFoundException, SQLException{
		...
		Class.forName(type.getDriver());
		String url = type.getUrl(entity.getHost(), entity.getPort(), entity.getDbName());
	...
	public static boolean checkTableExist(String table, Connection connection) throws SQLException {
		boolean exist = false;
    ...
    public static void executeCreateTableSql(String sql, Connection connection) throws SQLException {
