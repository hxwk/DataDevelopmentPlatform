package com.dfssi.common.regex;
...
public class Validations {
	 ...
	 *
	 * @param time
	 * @return boolean 2016-7-19 下午5:13:25 by Chenhailong
	 */
	...
	public static final String IMSI = "^[1-9][0-9][0-9][0-9][0,1,2,3,4,5,6,7,9]\\d{10}|[1-9][0-9][0-9](11|20)\\d{10}$";
	 ...
	 * @return boolean 2016-7-19 下午4:50:06 by Chenhailong
	 */
	public static final String FIRM_CODE = "^[0-9A-Z]{9}$";
	...
	public static void main(String[] args) {
		...
		String key = "440106033887340";

		boolean bool = isIMSI(key);
