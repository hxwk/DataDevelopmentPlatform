...
package com.dfssi.common.logging;
...
public class LogstashAppender extends AppenderSkeleton {
  ...
  */
  ...
  /**
   * The MulticastDNS zone advertised by a LogstashAppender
   */
  ...
  */
  public LogstashAppender(InetAddress address, int port) {
  ...
  */
  public LogstashAppender(String host, int port) {
    this.port = port;
  ...
  */
  ...
  public void append(LoggingEvent event) {
    ...
    if(address==null) {
      errorHandler.error("No remote host is set for LogstashAppender named \""+
			this.name+"\".");
      return;
    }
  ...
  /**
   * The LogstashAppender does not use a layout. Hence, this method
