...
public class TransportConf {
  ...
  private final String NETWORK_VERBOSE_METRICS;
  ...
  public TransportConf(String module, ConfigProvider conf) {
    ...
    NETWORK_VERBOSE_METRICS = getConfKey("io.enableVerboseMetrics");
  }
  ...
  public String ioMode() {
    return conf.get(NETWORK_IO_MODE_KEY, "NIO").toUpperCase(Locale.ROOT);
  }
  ...
  public int backLog() { return conf.getInt(NETWORK_IO_BACKLOG_KEY, -1); }

  /** Number of threads used in the server thread pool. Default to 0, which is 2x#cores. */
  public int serverThreads() { return conf.getInt(NETWORK_IO_SERVERTHREADS_KEY, 0); }

  /** Number of threads used in the client thread pool. Default to 0, which is 2x#cores. */
  public int clientThreads() { return conf.getInt(NETWORK_IO_CLIENTTHREADS_KEY, 0); }
   ...
   */
  public int receiveBuf() { return conf.getInt(NETWORK_IO_RECEIVEBUFFER_KEY, -1); }

  /** Send buffer size (SO_SNDBUF). */
  public int sendBuf() { return conf.getInt(NETWORK_IO_SENDBUFFER_KEY, -1); }
   ...
   */
  public int maxIORetries() { return conf.getInt(NETWORK_IO_MAXRETRIES_KEY, 3); }
  ...
  public int ioRetryWaitTimeMs() {
    return (int) JavaUtils.timeStringAsSec(conf.get(NETWORK_IO_RETRYWAIT_KEY, "5s")) * 1000;
  }
  ...
  public boolean verboseMetrics() {
    return conf.getBoolean(NETWORK_VERBOSE_METRICS, false);
  }
