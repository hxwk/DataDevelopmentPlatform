 ...
 * @since   JDK 1.7
 */
public class GeoEventRecordsTimeRangeFilter extends FilterBase {

	static final Log LOG = LogFactory.getLog(GeoEventRecordsTimeRangeFilter.class);
	...
	public GeoEventRecordsTimeRangeFilter(byte[] columnFamily, byte[] columnQualifier,
	...
	public static GeoEventRecordsTimeRangeFilter parseFrom(final byte [] pbBytes)
	    ...
	    return new GeoEventRecordsTimeRangeFilter(proto.getColumnFamily().toByteArray(),
	...
	public static Filter createFilterFromArguments(ArrayList<byte []> filterArguments) {
	   ...
	   checkArgument(filterArguments.size() == 4 || filterArguments.size() == 6,
	    ...
	    GeoEventRecordsTimeRangeFilter filter = new GeoEventRecordsTimeRangeFilter(family, qualifier, upper, lower);
	...
	boolean areSerializedFieldsEqual(Filter o) {
	    ...
	    if (!(o instanceof GeoEventRecordsTimeRangeFilter)) return false;

	    GeoEventRecordsTimeRangeFilter other = (GeoEventRecordsTimeRangeFilter)o;
