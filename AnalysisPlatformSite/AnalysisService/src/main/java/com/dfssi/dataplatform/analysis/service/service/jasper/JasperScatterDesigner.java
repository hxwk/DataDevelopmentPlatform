 ...
 **/
public class JasperScatterDesigner extends AbstractJasperReportDesigner {
    /**
     * 创建散点图报表
     *
    ...
    public JasperReport createJapserReport(VoJasperParam voJasperParam) throws JRException {
        ...
        yField.setValueClass(Integer.class);
        ...
        //定义bar chart
        JRDesignChart jrDesignChart = new JRDesignChart(jasperDesign, JRChart.CHART_TYPE_SCATTER);
        ...
        labelExpression.setText("String.valueOf($F{" + fields.getyValueField() + "}/$F{" + fields.getxValueField() + "})");
